...
PREDICTION_FREEZE_SCHEMA_VERSION = 20
...
PRED_SECTOR_DIVERSITY_TOP_K = _positive_int_env("PRED_SECTOR_DIVERSITY_TOP_K", 12)
...
PRED_PRECISION_MIN_CONVICTION = _float_env("PRED_PRECISION_MIN_CONVICTION", 0.52)
