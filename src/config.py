...
PREDICTION_FREEZE_SCHEMA_VERSION = 28
...
PRED_FACTOR_W_NEWS = _float_env("PRED_FACTOR_W_NEWS", 0.03)
...
PRED_INDUSTRY_MUST_KEEP_MAX = _positive_int_env("PRED_INDUSTRY_MUST_KEEP_MAX", 120)
PRED_INDUSTRY_MUST_KEEP_SWAP_MAX = _positive_int_env("PRED_INDUSTRY_MUST_KEEP_SWAP_MAX", 45)
PRED_PREPOOL_HOT_PROMOTE_MAX = _positive_int_env("PRED_PREPOOL_HOT_PROMOTE_MAX", 0)
