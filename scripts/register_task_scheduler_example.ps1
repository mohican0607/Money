# 작업 스케줄러에 "거래일 14:30" 등록 예시
# - 매일 14:30 (토·일·공휴일은 스크립트가 즉시 종료)
...
# schtasks /Create /TN "MoneyKRX_Daily1500" /TR $Tr /SC DAILY /ST 14:30 /RL HIGHEST /F

Write-Host "[예시] 작업 스케줄 등록은 비활성화되어 있습니다. 활성화하려면 schtasks 줄의 선행 # 을 제거하세요."
Write-Host "등록 예정: MoneyKRX_Daily1500 (매일 14:30) -> $Ps1"
